...
class MemberFilterExpressionSpec extends Spec with BeforeAndAfter with ShouldMatchers {
  ...
  describe("parse") {
    ...
    it ("should parse a simple filter expression") {
      ...
      f.getClass should equal (classOf[MemberFilterExpression[_]])
    }
    ...
    describe ("value parser") {
      ...
      it ("should parse a date") {
        ...
        f.values should equal (List(Convert.toDate("2010-01-01").get))
      }
      ...
      it ("should parse a list of dates") {
        ...
        f.values should equal (List(Convert.toDate("2010-01-01").get, Convert.toDate("2010-01-02").get))
      }
